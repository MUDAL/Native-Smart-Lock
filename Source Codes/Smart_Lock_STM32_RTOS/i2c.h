...
extern void I2C_WriteByte(I2C_TypeDef* I2Cx, 
                          uint8_t slaveAddr,
                          uint8_t regAddr,
                          uint8_t data);

extern void I2C_WriteMultiByte(I2C_TypeDef* I2Cx, 
                               uint8_t slaveAddr,
                               uint8_t regAddr,
                               uint8_t* pData,
                               uint32_t length);

extern void I2C_ReadByte(I2C_TypeDef* I2Cx,
                         uint8_t slaveAddr,
                         uint8_t regAddr, 
                         uint8_t* pData); 

extern void I2C_Read2Bytes(I2C_TypeDef* I2Cx, 
                           uint8_t slaveAddr,
                           uint8_t regAddr,
                           uint8_t* pData);

extern void I2C_ReadMultiByte(I2C_TypeDef* I2Cx,
                              uint8_t slaveAddr,
                              uint8_t regAddr,
                              uint8_t* pData,
                              uint32_t length); 
