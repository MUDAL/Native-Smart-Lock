...
extern uint8_t Fingerprint_EmptyDatabase(void);
extern uint8_t Fingerprint_StoreModel(uint16_t id);
extern uint8_t Fingerprint_LoadModel(uint16_t id);
extern uint8_t Fingerprint_GetModel(void);
extern uint8_t Fingerprint_DeleteModel(uint16_t id);
extern uint8_t Fingerprint_FingerFastSearch(void);
